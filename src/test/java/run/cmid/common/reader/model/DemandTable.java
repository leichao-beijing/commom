...
public class DemandTable {
    ...
    @ExcelConverterList(value = {
            @ExcelConverterSimple(value = { "K1" }) ,
            @ExcelConverterSimple(value = { "K21" },checkNull = true),
            @ExcelConverterSimple(value = { "时间" })
    })
    private ArrayList<String> list;

    @ExcelConverter(values = { "时间" }, model = ExcelReadType.INCLUDE)
    private Date date;
