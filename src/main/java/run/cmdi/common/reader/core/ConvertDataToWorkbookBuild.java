...
public class ConvertDataToWorkbookBuild<T, PAGE, UNIT> extends EntityBuildings<T> implements DataConvertInterface<T> {
     ...
     */
    public ConvertDataToWorkbookBuild<T, PAGE, UNIT> exceptFieldName(String... fieldName) {
    ...
    public ConvertDataToWorkbookBuild(WorkbookInfo workbookInfo, Class<T> clazz)
            throws IOException, ConverterExcelException {
        this(workbookInfo, null, ConvertPlugin.buildMap(clazz), clazz);
    }

    public ConvertDataToWorkbookBuild(WorkbookInfo workbookInfo, String sheetName, Class<T> clazz) {
        this(workbookInfo, sheetName, ConvertPlugin.buildMap(clazz), clazz);
    }

    public ConvertDataToWorkbookBuild(WorkbookInfo workbookInfo, String sheetName, Map<String, PluginMainOne<ConvertPlugin<T>>> map,
                                      Class<T> clazz) {
